      ...
      <div className="project_1">
        ...
        <div className="pr-[15rem]">
          <div className="description mb-2">
            ...
            <p>
              This is a Loyalty application which is made by my team. Now our
              team is taking responsibility maintenance for this product.
              Besides, analyze data is used in application for transfering these
              data into web report for client and exposing api for partners
              integrate.
            </p>
          </div>
          <div className="description mb-2">
